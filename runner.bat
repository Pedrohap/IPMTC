...
for %%d in (8 15 25 50 100 200 ) do (
    ...
    echo.NOME_SOLU^|VAL_SOLUCAO_INICIAL^|QTD_TROCAS_SOL_INCIAL^|VAL_SOLUCAO_POS_REFI^|QTD_TROCAS_POS_REFI^|QTD_ITERACOES^|TEMPO_HC^|TEMPO_REF^|TEMPO_TOTAL >> "solucoes\%%djobs\result.csv"
