...
void crossOver(vector <Particle>& particles){
    ...
    for (int i = 0 ; i < porcentagem15 ; i++){
        if (i < porcentagem10){
            int paiPos = randomInt(qtd_particulas - porcentagem15,qtd_particulas);
            int maePos = randomInt(qtd_particulas - porcentagem15,qtd_particulas);

            while (paiPos == maePos){
                maePos = randomInt(porcentagem15,qtd_particulas);
            }
